...
function propDrawer(id){
  ...
  const propFichaBtns=_semDono?'<div class="fz11 t500" style="margin-top:10px;margin-bottom:6px">Sem proprietário — envie a ficha pra ele preencher os dados:</div><div class="fx wrap g2">'+_fichasProp.map(f=>'<button class="btn btn-outline sm" data-action="prop-ficha-copy" data-arq="'+f[0]+'" data-imovel="'+esc(p.id)+'">'+icon('copy',14)+f[1]+'</button>').join('')+'</div>':'';
